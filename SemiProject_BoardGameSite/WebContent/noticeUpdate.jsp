...
<<<<<<< HEAD
		...
		<table align = "center" width = "900px" height="600px">
			<tr>
				<td></td>
				<td>
					<textarea rows="10" cols="30" id= "ir1" name = "ir1" style="width:766px; height:412px; align:center"><%=dto.getContent() %></textarea>
	...
	<tr>
		<td>
			<div class="form-group">
				<input type = "text" id = "title" name = "title" style = "width : 660px;" value = "<%=dto.getTitle() %>" class="form-control">
			</div>
		</td>	
	</tr>
	<tr>
		...
		<td align="center">
			<textarea id= "ir1" name = "ir1" style="width:650px; height:400px; align:center"><%=dto.getContent() %></textarea>
			<input type = "hidden" name= "wDate">
			<script type = "text/javascript">
				var oEditors = [];
				$(function() {
